...
<table class="table table-dark table-striped table-hover text-center">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $value["deskripsi_singkat"] ?></td>
            <td><img src="../../assets/img/blog/<?php echo $value["foto"] ?>" width="250px"></td>
			<td>
		...
		<div class="modal-content">
			...
			<form action="edit.php" method="POST" enctype="multipart/form-data">
				<div class="modal-body">
                    ...
                    <div class="mb-3">
						<label for="deskripsi_singkat" class="col-form-label">Deskripsi Singkat:</label>
						<input type="text" name="deskripsi_singkat" class="form-control" value="<?php echo $value['deskripsi_singkat'] ?>" id="deskripsi_singkat">
					</div>
					<div class="mb-3">
						<label for="deskripsi" class="col-form-label">Deskripsi:</label>
						<textarea rows="10" type="text" name="deskripsi" class="form-control" id="deskripsi"><?php echo $value['deskripsi'] ?></textarea>
					</div>
					<div class="mb-3">
		...
		<div class="modal-content">
			...
			<form action="add.php" method="POST" enctype="multipart/form-data">
				<div class="modal-body">
					...
					<div class="mb-3">
						<label for="deskripsi" class="col-form-label">Deskripsi:</label>
						<textarea cols="20" rows="10" type="text" name="deskripsi" class="form-control" id="deskripsi"></textarea>
					</div>
					<div class="mb-3">
						<label for="foto_pegawai" class="col-form-label">Input Foto Pegawai:</label>

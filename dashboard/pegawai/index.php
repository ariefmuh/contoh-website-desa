...
<table class="table table-dark table-striped table-hover text-center">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><img src="../../assets/img/team/<?php echo $value["foto"] ?>" width="250px"></td>
			<td>
			...
			<form action="edit.php" method="POST" enctype="multipart/form-data">
				<div class="modal-body">
                    ...
                    <div class="mb-3">
						...
						<input type="text" name="nama" class="form-control" value="<?php echo $value['nama'] ?>" id="nama">
					</div>
                    <div class="mb-3">
						<label for="jabatan" class="col-form-label">Jabatan:</label>
						<input type="text" name="jabatan" class="form-control" value="<?php echo $value['jabatan'] ?>" id="jabatan">
					</div>
					<div class="mb-3">
